...
public class VetoClient {
     ...
     */
    public record Call(Status status, VetoJudgment judgment, String rawOutput, String model, String responseId,
    ...
    public VetoClient(OpenAiClientFactory factory, AiProperties props) {
