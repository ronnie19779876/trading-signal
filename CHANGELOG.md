...
前端逐页改版都进 3.0.6，每轮审核先部署预发布版到生产：**3.0.6-rc.1**（2026-09-19，持仓页、账户页、仪表盘小改）；**3.0.6-rc.2**（2026-09-19，K 线均线、禁用滚轮、去掉公司简介）；**3.0.6-rc.3**（2026-09-19，实时账户盘中 1 秒刷新）；**3.0.6-rc.4**（2026-09-19，基本面页、全市场估值接口）；**3.0.6-rc.5**（2026-09-19，筛选表分页）；**3.0.6-rc.6**（2026-09-19，入场信号页）；**3.0.6-rc.7**（2026-09-19，系统页）。
