...
**生产跑 3.0.7**（2026-09-19 美东 20:01 部署；3.0.6 于 09-19 01:38 部署，审核期间 09-18 晚至 09-19 凌晨先后部署 rc.1～rc.7；第 3 期见 ARCHITECTURE §16，2.0.2 全量审查后的修复见 §17）。
...
**3.0.8 已发布，待部署到生产**：修再次订阅时账户汇总被 322 拒、资金取不到（订阅前补发取消、322 自愈、错误恢复后清 `lastError`）。
