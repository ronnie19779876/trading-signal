...
**生产跑 3.0.6-rc.4**（2026-09-18 美东 23:29 部署，预发布审核版；rc.1 22:53、rc.2 23:03、rc.3 23:12；当晚先后部署 3.0.2 20:36、3.0.3 21:10、3.0.4 21:42、3.0.5 22:00，3.0.1 未单独部署；第 3 期见 ARCHITECTURE §16，2.0.2 全量审查后的修复见 §17）。
...
**3.0.6 预发布审核中**：前端逐页改版都进 3.0.6，每轮审核部署一个 rc 到生产（rc.1 = 持仓页、账户页；rc.2 = K 线均线、禁用滚轮；rc.3 = 盘中 1 秒刷新；rc.4 = 基本面页与全市场估值接口；rc.5 = 筛选表分页，已发布待部署），全部审完发正式版。
